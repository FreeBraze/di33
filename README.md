...
<head>
  ...
  <title>单词趣味消消乐 - Unit 3 Heroes of our time</title>
  <style>
    * {
      margin: 0;
      padding: 0;
    ...
    .player-section:nth-child(2).show-double {
      display: block;
    }

    .player-section:nth-child(1).hide-single {
      display: none;
    }
...
<body>
  ...
  <div class="container">
    ...
    <div class="page unit-selection-page active" id="unitSelectionPage">
      ...
      <div class="units-container">
        <div class="unit-item">
          <div class="unit-circle"><span>Unit 3</span></div>
          <div class="unit-card" data-unit="1">
            <h3>Heroes of our time</h3>
            <p>时代英雄 | 共15个词汇</p>
          </div>
        </div>
      </div>
    ...
    <div class="page unit-detail-page" id="unitDetailPage">
      ...
      <div class="unit-circle"><span id="currentUnit">Unit 3</span></div>
      <div class="dropdown-area">
        <div class="dropdown" id="unitDropdown">Heroes of our time</div>
      </div>
    ...
    <div class="page game-page" id="gamePage">
      ...
      <div class="game-controls">
        <div class="control-group">
          <!-- 增加click-label类，点击交互 -->
          <div>单元:<span class="click-label" id="currentUnitDisplay">Unit 3</span></div>
  ...
  <script>
    ...
    const CONFIG = {
      wordLibrary: {
        1: [
          { english: "plump", chinese: "圆鼓鼓的；胖乎乎的" },
          { english: "vigor", chinese: "精力；力量；活力；热情" },
          { english: "crossbreed", chinese: "使杂交" },
          { english: "domesticated", chinese: "(动物)驯化的；(植物)人工培养的" },
          { english: "self‑pollinator", chinese: "自花传粉种" },
          { english: "asteroid", chinese: "小行星(尤指火星和木星之间)" },
          { english: "adulation", chinese: "(尤指对名人的)过分赞扬，恭维" },
          { english: "graft", chinese: "嫁接" },
          { english: "moonflower", chinese: "月光花" },
          { english: "pumpkin", chinese: "南瓜" },
          { english: "hybridize", chinese: "(使)杂交" },
          { english: "hectare", chinese: "公顷(10 000平方米)" },
          { english: "chrysanthemum", chinese: "菊花" },
          { english: "mourn", chinese: "悼念；哀悼；为…哀痛" },
          { english: "mourner", chinese: "吊唁者；哀悼者" }
        ]
      },
      unitInfo: { 1: { title: "Unit 3", topic: "Heroes of our time", desc: "时代英雄" } },
      audioMute: false,
      audioCtx: null
    };
    // 游戏状态全局变量
    ...
    function setupGame() {
      ...
      gameState = {
        ...
        mode: gameState.mode, unit: 1, diff: Number(DOM.diffSel.value)
      };
      // 更新页面显示文字
      const unitInfo = CONFIG.unitInfo[1];
      ...
      // 随机抽取指定数量单词
      const allWords = CONFIG.wordLibrary[1];
